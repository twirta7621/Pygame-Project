...
game = Game(800,600,"Gone Jellyfishing",time =30)
...
bks = Sound("sound\\gamemusic.wav",1)
...
end = Image("images\\END SCREEN.png",game)
title.resizeTo(game.width,game.height)
title.draw()
game.drawText(" Use Arrow Keys to Move-Avoid Plankton-Catch Jellyfish-If You Go Off Screen, You Will Reappear in the Center of the Screen",000,500)
game.drawText("Center of the Screen",0,525)
game.update(1)
game.wait(K_SPACE)
